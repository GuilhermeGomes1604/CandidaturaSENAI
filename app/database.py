...
def init_db():
    ...
    banco.execute_non_query("""
        CREATE TABLE IF NOT EXISTS requisicoes_mudanca_senha (
            nome VARCHAR(255) NOT NULL,
    ...
    banco.execute_non_query("""
        CREATE TABLE IF NOT EXISTS fase (
            fase VARCHAR(11) NOT NULL -- Preparação/Candidatura/Seleção/Divulgação (As fases do sistema)
        )
    """)
    ...
    banco.execute_non_query(""" -- Conta inicial de administrador.
        INSERT INTO admins (nome, cpf, senha)
        VALUES (%s, %s, %s)
    """, criptografar('Administrador Teste'), criptografar('000.000.023-34'), generate_password_hash('xxxxxxxx'))